              ...
              >
                {code.map((digit, index) => (
                  <input
                    ...
                    className={`w-12 h-12 text-center text-xl text-[#000000] font-semibold border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-colors ${
            ...
            <div className="mt-6">
              <p className="text-gray-500 text-sm">
                ...
                <button
                  ...
                  className="text-blue-600 hover:text-blue-800 font-medium underline focus:outline-none focus:ring-2 focus:ring-blue-200 rounded-md"
                >
                  Resend
                </button>
              </p>
