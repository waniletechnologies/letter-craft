...
interface InactiveClientPopupProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

const InactiveClientPopup: React.FC<InactiveClientPopupProps> = ({
  isOpen,
  onClose,
  onConfirm,
}) => {
      ...
      <div className="bg-white rounded-xl p-6 w-80 shadow-xl">
        <div className="text-center mb-6">
          <h3 className="text-lg font-medium text-gray-900 mb-1">
            Are you sure you want to In active
          </h3>
...
export default InactiveClientPopup;
