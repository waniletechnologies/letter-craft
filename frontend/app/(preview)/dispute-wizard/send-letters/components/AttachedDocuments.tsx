  ...
  return (
    <div className="space-y-4">
      <div className="font-medium text-[15px] leading-[32px] -tracking-[0.04em] text-[#71717A] ">
        Where do you want to include ID attachments? (Typically only needed for
        Round 1).
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-3">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              onIncludeIdAttachmentsChange(checked === true)
            }
          />
        ...
        {/* {includeIdAttachments && (
          <div className="ml-6 flex gap-2">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="round1" className="text-sm">
                All round 1 letters (Recommended)
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <input
        ...
        <div className="flex items-center gap-3">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              onIncludeReturnAddressChange(checked === true)
            }
          />
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {documents.map((doc, index) => (
            <div
              key={index}
              className="flex items-center gap-3 p-3 border border-[#EFEFEF] rounded-lg"
            >
              ...
              <div className="flex flex-col gap-1">
                <span className="font-semibold text-xs leading-sm tracking-md text-[#1C1C1C]">
                  {doc.name}
                  {doc.isFtcReport && " (FTC Report)"}
                </span>
                <span className="font-normal text-xs leading-sm tracking-md text-[#1C1C1C] uppercase">
